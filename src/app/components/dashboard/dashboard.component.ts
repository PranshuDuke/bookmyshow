...
export class DashboardComponent implements OnInit {
  ...
  refreshList(){
    this.http.get<any>('https://localhost:44318/api/v1.0/moviebooking/all')
    .subscribe(data=>{
      this.movies=data;
    })
  }
  refreshList2(){
    this.http.get<any>('https://localhost:44318/api/v1.0/moviebooking/tickets/all')
    .subscribe(data=>{
      this.tickets=data;
    })
  }
  ...
  updateClick(){
    var val={
        ...
        Status:this.Status };
    this.http.put('https://localhost:44318/api/v1.0/moviebooking/updatemoviebyadmin',val)
    .subscribe(res=>{
  ...
  updateClick2(){
    ...
    this.http.put('https://localhost:44318/api/v1.0/moviebooking/update',val)
    .subscribe(res=>{
  ...
  createClick(){
    ...
    this.http.post('https://localhost:44318/api/v1.0/moviebooking/add',val)
    .subscribe(res=>{
  ...
  createClick2(){
    ...
    this.http.post('https://localhost:44318/api/v1.0/moviebooking/addTicket',val)
    .subscribe(res=>{
  ...
  deleteClick(id:any){
    if(confirm('Are you sure?')){
      this.http.delete('https://localhost:44318/api/v1.0/moviebooking/delete/'+id)
      .subscribe(res=>{
    ...
    deleteClick2(id:any){
      if(confirm('Are you sure?')){
        this.http.delete('https://localhost:44318/api/v1.0/moviebooking/deleteticket/'+id)
        .subscribe(res=>{
